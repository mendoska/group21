...
def runGA(threatFileLocation):
    ...
    def on_gen(ga_instance):
        ...
        # print("Fitness of the best solution :", bestPercent:=ga_instance.best_solution()[1], "\n")
        if ga_instance.generations_completed == num_generations :
            ...
            for solution in range(len(ga_instance.best_solution()[0])):
                ...
                if ga_instance.best_solution()[0][solution] == 1:
                    tempList.append(f"[THREAT: {function_inputs[solution]}, Weapon Chosen: 'Long Range Missile']")
                    continue
                if ga_instance.best_solution()[0][solution] == 2:
                    tempList.append(f"[THREAT: {function_inputs[solution]}, Weapon Chosen: 'Medium Range Missile']")
                    continue
                if ga_instance.best_solution()[0][solution] == 3:
                    tempList.append(f"[THREAT: {function_inputs[solution]}, Weapon Chosen: 'Short Range Missile']")
                    continue
                if ga_instance.best_solution()[0][solution] == 4:
                    tempList.append(f"[THREAT: {function_inputs[solution]}, Weapon Chosen: 'Directed Energy']")
                    continue
            global response
